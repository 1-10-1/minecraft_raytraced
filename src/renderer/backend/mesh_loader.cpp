...
namespace renderer::backend
{
    auto loadGltfMeshes(Device& device,
                        ...
                        std::filesystem::path const& filePath) -> std::optional<std::vector<std::shared_ptr<MeshAsset>>>
    {
        logger::debug("Loading gltf: {}", filePath.c_str());
        ...
        for (fastgltf::Mesh& mesh : gltf.meshes)
        {
            ...
            newmesh.meshBuffers = uploadMesh(device, allocator, cmdManager, vertices, indices);
