  ...
  // use models where a vertex can have multiple texture coordinates so we always take the first set (0).
            ...
            .tangent =
                mesh->mTextureCoords[0] != nullptr
                    ...
                    : glm::vec3 {},
            .bitangent = mesh->mTextureCoords[0] != nullptr ? glm::vec3 { mesh->mBitangents[i].x,
...
auto Model::loadMaterialTextures(aiMaterial* mat, aiTextureType type, TextureType typeEnum)
